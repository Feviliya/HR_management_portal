  ...
  return (
    <div className='dash-emp-contents'>
        ...
        <div className='handbook boxes'>
            ...
            <Link to="https://www.501commons.org/resources/tools-and-best-practices/human-resources/sample-employee-handbook-national-council-of-nonprofits" className='hand-book' >Employee handbook</Link>
        ...
        <div className='ref boxes'>
            ...
            <Link to='https://resources.workable.com/wp-content/uploads/2017/09/Employee-Handbook.pdf' className='ref-mat'>Referance materials</Link>
